...
const routes: Routes = [
  { path: 'camera', component: ReactCameraComponent, canActivate: [AuthGuardService] },
  { path: 'camera/:idTopic', component: ReactCameraComponent, canActivate: [AuthGuardService] },
